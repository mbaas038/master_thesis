...
GPUS=0
MDIR=/data/s3212262/thesis_data/models/OpenSubtitles/context_900/msent-ennl-BPE96000-1-27000
...
function seg_apply {
	...
	cat $TESTDIR/test.it.900.dec.en \
	...
	> $MDIR/spm/test.it.dec.spm.$SL
        ...
        cat $TESTDIR/test.you.900.dec.en \
        | $SPM/spm_encode --model=$MDIR/spm/spm.model \
        --vocabulary=$MDIR/spm/spm.vocab.$SL --vocabulary_threshold=50 \
