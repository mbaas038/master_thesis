...
function model_sent {
##	TIME=3:00:00
##	~/bin/rjob_v100.sh -p regular -m 32GB -t $TIME ./model_sent.sh 48000 1 35 27000


    TIME=12:00:00
    ~/bin/rjob_v100.sh -p gpu -t $TIME -m 8GB ./model_sent.sh 2000 1 35 27000
...
function decodes {
    TIME=00:20:00
    ~/bin/rjob_v100.sh -p gpushort -t $TIME ./decode.sh 5 1.0 8 27000
}
